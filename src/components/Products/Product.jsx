      ...
      <div>
        ...
        <main className="mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-5">
            <h1 className="font-bold text-2xl tracking-wide text-gray-600">Products</h1>
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <div className='hidden lg:block'>
                <div className='flex justify-between items-center py-3'>
                  <h2 className='opacity-50'>Filters</h2>
                  <FilterListIcon sx={{ opacity: 0.5 }} />
                </div>
                              ...
                              <FormControl>
                                ...
                                >
                                  {section.options.map((option, optionIdx) => (
                                    ...
                                    <FormControlLabel onChange={(e) => handleRadioFilterChange(e, section.id)} key={option.value} value={option.value} control={<Radio />} label={option.label} />
